...
--Euclid's div (taken from Chinmaya's code, needed for tofinNat to work)
...
--Nat to Fin (modular values) (this was deleted from BaseN, I put it here and removed the import)
